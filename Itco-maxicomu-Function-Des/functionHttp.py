...
whatsapp_token = "EAATVIxJamLkBO8zxnPulQAzX6y5M3vHpLSDkeSWNtex3IDDyFrlWrIjj2WjNjSmdsJG5VBXPmHKGXT1DbQYaZAesb2IrDGNWKmTZBjTBv05jcDbqxlaxTQ0ZButKVe65Gf3thHHNsHd95anbdM0UA3HgfaxyoBPy0RF0rgoacPBFW0UB4nAzKvtfhhyCYQAwgZDZD"
...
def download_vectorialdb():
    ...
    try:
        ...
        data = client.get_blob_client("index.faiss").download_blob().readall()
        ...
        pkl = client.get_blob_client("index.pkl").download_blob().readall()
...
def openai_request(value, **kwargs):
    ...
    try:
        client = CosmosClient(db_endpoint, credential=credential)
        ...
        if "servidumbre" in message.lower():
            message = (
                "Estoy haciendo una consulta legal sobre una servidumbre eléctrica. "
...
def send_whatsapp_message(body, message):
    ...
    try:
        ...
        logging.info(f"whatsapp_token:{whatsapp_token}")
        headers = {
